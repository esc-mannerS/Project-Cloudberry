              ...
              <div class="body-content">
                <div class="panel-panel">
                  <div class="panel-group">
                    <div class="panel-head"><h3>Hvad er SagaSwap</h3></div>
                    <div class="panel-body">
                      ...
                      <p>
                        Hvis du har inpiration, feedback, fejl eller andet, er
                        du mere end velkommen til at kontakte os, gennem en af
                        nedenstående kanaler.
                      </p>
                      <div class="panel-contact">
                        <a href="https://x.com"
                          ><img src="x-logo.svg" class="panel-body-some"
                        /></a>
                        <p>
                  ...
                  <div class="panel-group">
                    ...
                    <div class="panel-body">
                      <p>
                        Oppe i højre hjørne kan du se "Log ind". Klik her og du
                        kommer ind til log ind siden. Lige under "Log Ind"
                        knappen kan du klikke på "Opret Bruger".
                      </p>
                      <p>
